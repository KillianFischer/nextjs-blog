        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a href="#" className="text-gray-400 hover:text-cherry-500">
            ...
            <div className="space-y-4">
              ...
              <div className="flex">
                <input 
                  ...
                  className="bg-zinc-800 text-white px-4 py-2 rounded-l-full focus:outline-none focus:ring-2 focus:ring-cherry-500 flex-1"
                />
                <button className="bg-cherry-500 text-white px-6 py-2 rounded-r-full hover:bg-cherry-600">
                  Subscribe
                </button>
              </div>
            </div>
